...
class BinaryEditor:
    ...
    def load_map_image(self, scenario_file):
        script_dir = os.path.dirname(os.path.abspath(__file__))

        base_name = os.path.basename(scenario_file)
        base_name = base_name.split(".bin")[0]
